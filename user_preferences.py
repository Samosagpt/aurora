...
class UserPreferencesManager:
    ...
    def set_category_preferences(self, category: str, preferences: Dict[str, Any], auto_save: bool = True) -> bool:
    ...
    def get_image_generation_defaults(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "resolution": self.get_preference("image_generation", "preferred_resolution", [512, 512]),
            ...
            "use_safety_checker": self.get_preference("image_generation", "use_safety_checker", True)
        }
    ...
    def get_video_generation_defaults(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "resolution": self.get_preference("video_generation", "preferred_resolution", [512, 512]),
