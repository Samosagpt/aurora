"""
Image Generation Manager for Samosa GPT with Hugging Face integration
"""
import os
import logging
import shutil
...
class ImageModelManager:
    """Enhanced image model management with Hugging Face integration"""
    ...
    def install_model(self, model_name: str) -> bool:
        ...
        try:
            ...
            log_manager.append_md_log('Model Install', f"Starting installation of {model_name}")
            ...
            log_manager.append_md_log('Model Install', f"Successfully installed {model_name}")
            ...
            log_manager.append_md_log('Model Install Error', error_msg)
            return False
    ...
    def add_custom_model(self, model_name: str, model_id: str) -> bool:
        ...
        try:
            ...
            log_manager.append_md_log('Custom Model Added', f"Added {model_name} ({model_id})")
            ...
            logger.error(error_msg)
            log_manager.append_md_log('Custom Model Error', error_msg)
            return False
