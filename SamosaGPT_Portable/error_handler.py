...
class ErrorHandler:
    ...
    def handle_error(self, error: Exception, context: str = "", user_message: str = None) -> str:
        ...
        friendly_message = friendly_messages.get(error_type, "An unexpected error occurred. Please try again.")
    ...
    def log_access(self, endpoint: str, user_id: str = "anonymous", duration: float = 0):
        ...
        self.access_logger.info(f"User: {user_id} | Endpoint: {endpoint} | Duration: {duration:.2f}s")
