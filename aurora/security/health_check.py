...
from aurora.handlers.error_handler import get_health_status
...
class HealthCheck:
    ...
    def get_status(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        if (
            ...
            and self.last_check
            and current_time - self.last_check < self.cache_duration
        ):
    ...
    def _check_storage(self) -> Dict[str, Any]:
        ...
        for directory in required_dirs:
            try:
                ...
                results[str(directory)] = {"exists": True, "writable": True}
            except Exception as e:
        ...
        try:
            ...
            for test_dir in test_dirs:
                try:
                    ...
                    results[str(test_dir)] = {"readable": True, "writable": True}
                except Exception as e:
                    results[str(test_dir)] = {"readable": False, "writable": False, "error": str(e)}
