        ...
        for approach_name, load_kwargs in load_approaches:
            try:
                ...
                if "zeroscope" in model_id.lower():
                    pipeline = TextToVideoSDPipeline.from_pretrained(model_id, **base_kwargs)
                else:
                    pipeline = DiffusionPipeline.from_pretrained(model_id, **base_kwargs)
    ...
    try:
        ...
        with torch.no_grad():
            ...
            video_path = create_video_from_frames(
                frames, params["width"], params["height"], params["fps"], progress_placeholder
            )
